...
function M.get(spec, config)
 ...
 return {
    ...
    WinSeparator    = { fg = spec.bg3 }, -- the column separating vertically split windows
    ...
    Visual          = inv.visual and { style = "reverse" } or { fg = spec.selfg0, bg = spec.sel0 }, -- Visual mode selection
